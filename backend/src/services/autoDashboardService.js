...
[
  ...
  ...
    ...
    console.log('🤖 Generating dashboard insights with AI...');
    ...
    for (let i = 0; i < insights.length; i++) {
      ...
      try {
        ...
        console.warn(`⚠️  Skipping insight "${insight.title}": ${error.message}`);
    ...
    console.log(`✅ Validated ${validatedInsights.length} insights`);
